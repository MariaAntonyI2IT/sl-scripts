...
public class Constants {
    ...
    public static final String VILLAGE_OBJECT_QUERY = "select v.id as id, member_sequence as member_sequence, c.code as ccode, v.code as vcode  from village v  join chiefdom c on c.id = v.chiefdom_id ORDER BY v.id";
